...
def main():
    ...
    movie_service = MovieService(movie_repository, movie_validator, reservation_repository,undo_service)
    reservation_service = ReservationService(reservation_repository, reservation_validator, movie_repository,
                                             clientcard_repository,undo_service)
    clientcard_service = ClientcardService(clientcard_repository, clientcard_validator, reservation_repository,
                                           undo_service)

    cinema_ui = Console(movie_service, reservation_service, clientcard_service,undo_service)
